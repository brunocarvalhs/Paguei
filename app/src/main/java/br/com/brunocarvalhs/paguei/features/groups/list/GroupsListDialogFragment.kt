...
import br.com.brunocarvalhs.paguei.databinding.DialogGroupsListBinding
...
class GroupsListDialogFragment : BaseBottomSheetDialogFragment<DialogGroupsListBinding>(),
    ...
    private fun navigateToRegisterHomes() {
        val action =
            GroupsListDialogFragmentDirections.actionHomesListDialogFragmentToHomesRegisterFragment()
